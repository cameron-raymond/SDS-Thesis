...
<style>
  ...
  .oii_blue_logo {
    background-image: url("/oii_logo.svg");
    width: 90px;
    height: 90px;
    margin-right: 12px;
  }
  .oxford_blue_logo {
    background-image: url("/oxford_logo.svg");
    width: 90px;
    height: 90px;
  }
  .buffer {
...
{#if !(segment === undefined)}
  <Foot />
{/if}
<a href="/mock-environment" class="hide_link" aria-label=" ">mock_env</a>
<a href="/preliminary-questions" class="hide_link" aria-label=" ">mock_env</a>
